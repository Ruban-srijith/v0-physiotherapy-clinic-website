...
const services = [
  ...
  },
  {
    ...
    features: ["Injury Prevention", "Performance Analysis", "Return-to-Play Protocols"],
  },
  {
    ...
    features: ["Joint Mobilization", "Scar Tissue Management", "Progressive Loading"],
  },
]
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.title}
              className="group relative overflow-hidden rounded-3xl border border-border bg-card transition-all duration-500 hover:border-primary/30 hover:shadow-[0_0_40px_rgba(10,132,255,0.08)]"
            >
              {/* Image */}
